<main class="main prose p-10 max-w-none">
    <h1 class="text-yellow-header-title text-3xl mb-12 font-semibold">Les services d'aides à domicile dans votre secteur : </h1>
        ...
        <section class="all-saads">
            ...
            <?php foreach ($saads as $saad) {
                ...
                <article class="card border grid grid-cols-6 mt-5">
                    <img
                        class="col-1" src="<?php echo $saad['image']; ?>">
