<div class="bg-grey-recherche half-a-border-on-bottom">
    ...
    <?php
    /**
     * @var $saad array - le saad à créer ou à modifier
     * @var $success bool todo check à quoi ça sert
     * @var $publics array - liste des publics qui existent
     * @var $publicsCible array - liste des publics concernés par le saad
     * @var $pathologies array - liste des pathologies qui existent
     * @var $pathologiesSpecialise array - liste des pathologies spécialisées concernées par le saad
     */
    $errors = \Config\Services::validation()->getErrors();
    helper(['form']);
    ?>
    <?php if ($saad) { ?>
    <form action="<?php echo base_url(); ?>/SaadController/storeSaad/<?php echo $saad['id'] ?>"
          class="half-a-border-on-top" enctype="multipart/form-data" method="post">
        <div class="container m-auto md:max-w-screen-md">
            <h2 class="title pt-5">Modifier <?php echo $saad['nom'] ?> </h2>
            <?php } else { ?>
            <form action="<?php echo base_url(); ?>/SaadController/storeSaad" class="half-a-border-on-top"
                ...
                <div class="container m-auto md:max-w-screen-md">
                    ...
                    if ($success) {
                        ...
                        <div class="alert alert-success" role="alert">
                            <h4 class="alert-heading">Le SAAD a bien été créé !</h4>
                        ...
                        if (isset($success)) {
                            ...
                            <div class="alert alert-danger mb-8 text-center" role="alert">
                                ...
                                <h4 class="alert-heading text-red-700 font-bold">Le service n'a pas pu être enregistré
                                    !</h4>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        <div class="m-5 md:mr-5">
                            ...
                            } ?>" id="grid-nom" name="nom" type="text" placeholder="ex. Diminu'Tifs"
                                   value="<?php if (!isset($validation) && $saad) {
                                       echo $saad['nom'];
                                   } else echo set_value('nom'); ?>">
                            <?php if (isset($errors['nom'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">Le Nom de la structure doit être
                                    renseigné</p><?php
                            } ?>
                        ...
                        <div class="m-5 md:ml-5">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 form-control <?php if (isset($errors['tel'])) {
                                ...
                                echo $saad['tel'];
                            } else echo set_value('tel'); ?>" name="tel" id="grid-tel" type="text"
                                   placeholder="ex. 0836656565">
                            <?php if (isset($errors['tel'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">Le numéro doit être
                                    valide</p><?php
                            } ?>
                        ...
                        <div class="m-5 md:ml-5">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 form-control <?php if (isset($errors['mail'])) {
                                ...
                                echo $saad['mail'];
                            } else echo set_value('mail'); ?>" id="grid-email" type="email" name="mail"
                                   placeholder="example@example.fr">
                            <?php if (isset($errors['mail'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">Renseignez une adresse mail
                                    valide</p><?php
                            } ?>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div class="m-5 md:mr-5">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white form-control <?php if (isset($errors['site'])) {
                                echo("is-invalid border-red-500");
                            } ?>" id="grid-site" name="site" type="text" placeholder="ex. diminutifs.com"
                                   value="<?php if (!isset($validation) && $saad) {
                                       echo $saad['site'];
                                   } else echo set_value('site'); ?>">
                            <?php if (isset($errors['site'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">L'URL renseignée est trop
                                    longue</p><?php
                            } ?>
                        ...
                        <div class="m-5 md:ml-5">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 form-control <?php if (isset($errors['siret_siren'])) {
                                ...
                                echo $saad['siret_siren'];
                            } else echo set_value('siret_siren'); ?>" name="siret_siren" id="grid-siret_siren"
                                   type="text" placeholder="ex. 12345678900001">
                        ...
                        <div class="m-5 md:ml-5">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 form-control <?php if (isset($errors['adresse'])) {
                                ...
                                echo $saad['adresse'];
                            } else echo set_value('adresse'); ?>" id="grid-adresse" type="adresse" name="adresse"
                                   placeholder="ex. 3 rue des lilas">
                            <?php if (isset($errors['adresse'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">l'adresse renseignée est trop
                                    longue</p><?php
                            } ?>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div>
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold ml-5 mb-2"
                                   for="idCategorie">
                                Catégorie
                            </label>
                            <select class="form-select bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mx-5 mb-5 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="idCategorie" name="idCategorie">
                                <option value="1" <?php if ($saad) {
                                    if ($saad['idCategorie'] == "1") {
                                        echo "selected";
                                    }
                                } else {
                                    if (set_value('idCategorie') == "1") {
                                        echo "selected";
                                    }
                                } ?>> CPOM 1
                                </option>
                        ...
                        <div><label class="block uppercase tracking-wide text-gray-700 text-xs font-bold ml-5 mb-2"
                                    for="image">
                            ...
                            <?php if (isset($errors['image'])) { ?>
                                <p class="text-red-500 text-xs italic invalid-feedback">Sélectionnez une image de
                                    maximum 100ko et 1024x768px</p><?php
                            } ?>
                        </div>
                    </div>

                    <p class="block uppercase tracking-wide text-gray-700 text-xs font-bold ml-5 mb-2"> Publics
                        cibles </p>
                    ...
                    <p class="block uppercase tracking-wide text-gray-700 text-xs font-bold ml-5 mb-2"> Pathologies
                        prises en charge </p>
                    <div class="flex items-center justify-center">
                        <div class="grid grid-cols-3 gap-1 text-left">
                            ...
                            foreach ($pathologies as $pathologie) {
                                ?>
                                <div class="mr-5"><input type="checkbox" name="pathologie[]"
                                                         value="<?php echo $pathologie['id'] ?>"
                                        <?php
